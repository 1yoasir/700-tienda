...
$pruducto=DAO::productoIdObtenerPorDenominacion($_REQUEST["denominacion"]);

$traza = new Traza($_SESSION["id"], "ProductoCrear", "Ha creado un  producto ", $producto["id"], date("F j, Y, g:i a"));
